...
from config import (LOG_GROUP_ID, LOG_SESSION, STRING1, STRING2, STRING3,
                    STRING4, STRING5)
from Rockz import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4, ASS_CLI_5,
                   ASSID1, ASSID2, ASSID3, ASSID4, ASSID5, ASSNAME1, ASSNAME2,
                   ASSNAME3, ASSNAME4, ASSNAME5, BOT_ID, BOT_NAME, LOG_CLIENT,
                   OWNER_ID, app)
from Rockz.Core.Clients.cli import LOG_CLIENT
from Rockz.Core.PyTgCalls.Rockz import (pytgcalls1, pytgcalls2, pytgcalls3,
                                        pytgcalls4, pytgcalls5)
from Rockz.Database import (get_active_chats, get_active_video_chats,
                            get_sudoers, is_on_off, remove_active_chat,
                            remove_active_video_chat)
from Rockz.Inline import private_panel
from Rockz.Plugins import ALL_MODULES
from Rockz.Utilities.inline import paginate_modules
...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Rockerz Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("Rockerz_Updates")
            await ASS_CLI_1.join_chat("Rockerz_Support")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("Rockerz_Updates")
            await ASS_CLI_2.join_chat("Rockerz_Support")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("Rockerz_Updates")
            await ASS_CLI_3.join_chat("Rockerz_Support")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("Rockerz_Updates")
            await ASS_CLI_4.join_chat("Rockerz_Support")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("Rockerz_Updates")
            await ASS_CLI_5.join_chat("Rockerz_Support")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("Rockerz_Updates")
            await LOG_CLIENT.join_chat("Rockerz_Support")
        except:
            pass
    console.print(f"└[red] Rockerz Music Bot Boot Completed.")
    if STRING1 != "None":
...
home_text_pm = f"""➪ Ꮋᴇʟʟᴏ Ꭰᴇᴀʀ ҒʀɪᴇɴᴅՏ [👋](https://telegra.ph/file/97fc56fca5a3f91c1fd82.jpg)

Ꮋᴇʏ Ꮇʏ Νᴀᴍᴇ ᏆՏ {BOT_NAME}.
Ꮖ Ꭺᴍ ᎷᴜՏɪᴄ + Ꮩɪᴅᴇᴏ Տᴛʀᴇᴀᴍᴇʀ ϴɴ Ͳᴇʟᴇɢʀᴀᴍ Ꮩᴏɪᴄᴇ Ꮯʜᴀᴛ [</Oꜰꜰʟɪɴᴇ> ‌[ᴀꜰᴋ]「™ʟᴏɢ✓ᴏᴜᴛ❥︎✔︎」🇮🇳](https://t.me/log_afk) .

Տᴇᴇ Ꮇʏ Ꭺʟʟ ᏟᴏᴍᴍᴀɴᴅՏ: /help """
...
@app.on_callback_query(filters.regex("Salim"))
