...
from Rockz import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Rockz import boottime as bot_start_time
from Rockz import db, random_assistant
from Rockz.Core.PyTgCalls import Rockz
from Rockz.Database import (add_nonadmin_chat, add_served_chat,
...
from Rockz.Decorators.admins import ActualAdminCB
from Rockz.Decorators.permission import PermissionCheck
from Rockz.Inline import (custommarkup, dashmarkup, setting_markup,
                          setting_markup2, start_pannel, usermarkup, volmarkup)
from Rockz.Utilities.assistant import get_assistant_details
from Rockz.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await Rockz.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"Rockz Disk Usage: {diske}%", show_alert=True
        )
